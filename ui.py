...
def about_dialog(settings):
	...
	ECS_logo_label.bind("<Button-1>", lambda e: go_to("https://monomorpho.github.io/Electron-Cells-Sandbox/"))

	info_label = Label(text="Electron Cells Sandbox. Fonts: Roboto, Geostar Fill.\n©Monomorpho feat Robotix 2021.\nAll rights reserved.", font="20", fg="#000000")	
	info_label.config(bg="#777777")
	info_label.pack(expand=True)

	Monomorpho_logo = PhotoImage(file="default_textures/ui/Monomorpho.png")
	Monomorpho_logo_label = Label(image=Monomorpho_logo, cursor='hand1')
	Monomorpho_logo_label.config(bg="#777777")
	Monomorpho_logo_label.pack(side=LEFT, expand=True)
	Monomorpho_logo_label.bind("<Button-1>", lambda e: go_to("https://monomorpho.github.io/"))
